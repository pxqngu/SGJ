    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="page-header">
                    <!--新建按钮-->
                    <button id="new-button" type="button" class="btn btn-sm btn-purple">
...
<script src="assets/js/sgj/pxqngu.sgj.bookmanage.js"></script>
<script>
    //-----------------------------------------------------------------------------------------------------------新建按钮处理
            ...
            bootbox.prompt({
                ...
                callback: function (result) {
                    ...
                    if ((result === "") || (result === null)) {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "workbook.do?oper=insert&bookName=" + result,
                            success: function (){
                                bootbox.alert("新建抄表本完成！")
                            }
                        });
                    }
                }
