    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h1 class="h1">欠费数据上传</h1>
                    </div>
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <!-- our form -->
                        <form id="fileUploadForm" class="dropzone" method="post" action="fileUpload.do?oper=fileupload_qf" enctype="multipart/form-data">
...
<script src="assets/js/dropzone.min.js" type="text/javascript" charset="UTF-8"></script>
